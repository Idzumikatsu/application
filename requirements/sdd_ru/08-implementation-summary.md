...
- **Широковещательные уведомления**: Реализована система массовой рассылки уведомлений с фильтрацией получателей
...
- `POST /api/notifications/broadcast` - Широковещательная рассылка уведомлений (готово для реализации)
